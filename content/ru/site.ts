...
export const siteContent = {
  ...
  companySummary:
    "В текущей структуре Pluto Enerji обеспечивает поставку тювенанного сырого каолина для оптового спроса быстро, надёжно и с коммерческой гибкостью, одновременно формируя инфраструктуру, подходящую для будущих процессов обогащения и выпуска переработанной продукции.",
  navigation: {
    primary: [
      { label: "Главная", path: "" },
