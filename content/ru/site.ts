...
export const siteContent = {
  ...
  siteDescription:
    "Поставка сырого каолина, портфель переработанного каолина и решения в области промышленных минералов для B2B-покупателей.",
  ...
  navigation: {
    primary: [
      ...
      { label: "Устойчивое развитие", path: "sustainability" },
