    ...
    items: [
      {
        title: "发展历程",
        paragraphs: [
          "Pluto Enerji 于 2020 年成立，秉持高效利用自然资源并实现高附加值转化的愿景。公司以原矿高岭土生产起步，持续紧跟行业需求，不断推进生产与开发能力建设。",
          "自成立以来，我们不仅专注于原料供应，也持续开展提升品质、拓展应用场景的相关工作。基于这一方向，我们正不断强化实验室基础设施，并持续向更具研发导向的组织结构转型。",
        ],
      },
      {
        title: "使命",
        paragraphs: [
          "通过高效利用天然高岭土资源，开发符合不同行业需求的可持续、高附加值产品。",
          "以科学方法和持续改进原则为基础，为客户提供可靠、注重性能的解决方案。",
        ],
      },
      {
        title: "愿景",
        paragraphs: [
          "在高岭土与工业矿物领域，不仅成为原料供应商，更成为能够开发产品、设计工艺并引领行业方向的技术与解决方案合作伙伴。",
          "依托研发实力、创新方法和技术专长，成长为国内外市场上具有竞争力与引领力的品牌。",
        ],
      },
    ],
  },
