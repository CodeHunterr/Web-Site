...
export const applicationsPageContent = {
  ...
  sectors: [
    ...
    },
    {
      title: "水泥",
      cardDescription:
        "面向水泥行业不断变化原料需求开发的可靠天然高岭土解决方案。Pluto Enerji 依托稳定的生产基础、可靠的原料供应能力以及长期合作导向，致力于为水泥生产企业提供可持续解决方案。",
      description:
        "面向水泥行业不断变化的原料需求而开发的可靠天然高岭土解决方案。我们矿区生产的天然高岭土，正围绕水泥行业对品质稳定性、供货连续性与可靠供应的要求进行评估与开发。Pluto Enerji 依托稳定的生产基础、持续的原料供应能力以及长期合作导向，致力于成为水泥生产企业值得信赖的供应伙伴。",
      features: [
        "适用于水泥生产工艺的天然高岭土供应",
        "以稳定化学组成和均一矿物特性为导向的质量管理方法",
        "依托持续生产实现可持续且可靠的原料供应",
        "面向不同工艺需求的技术评估与产品开发方法",
        "具备较高氧化铝潜力的矿物结构，并以降低铁含量为导向推进质量开发",
        "支持低碳水泥技术与 SCM 应用发展的产品开发愿景",
        "支持长期业务合作关系的供应模式",
        "能够适应行业变化需求的研发与持续改进体系",
      ],
      detailsCtaLabel: "查看详情",
      detailsCollapseLabel: "收起详情",
    },
  ],
  supplyHighlight: {
    section: {
